...
for infile in "${outdir}"/13634.clean_intron_deletions_with_strand_and_vaf_and_depth_and_numExons.tsv; do
  ...
  ./temp2.sh $genome $cohort $sample $outdir $tmpdir $infile_from_gridss $python_path $in_bam $infile $prev_outfile $outfile
