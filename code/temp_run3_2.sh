...
infile_from_gridss=$6 # the input gridss vcf file. It needs to be bgzip compressed as <name>.vcf.gz and tabix -p vcf indexed <name>.vcf.gz.tbi, and sample is the only sample in this vcf file.
