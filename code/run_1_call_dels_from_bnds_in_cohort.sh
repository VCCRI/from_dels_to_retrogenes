...
indir_for_gridss=$6 # the input gridss vcf files, with an asterisk as the first character of the basename, which is where the sample id will be and will be extracted from.
